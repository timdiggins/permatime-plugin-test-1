...
task :link_shared_stuff do
  #run "ln -nfs #{shared_path}/config/database.yml #{release_path}/config/database.yml" #no db!
...
#after "deploy:symlink", "install_gem_dependencies" #removed because requires sudo (needs to do local install)
